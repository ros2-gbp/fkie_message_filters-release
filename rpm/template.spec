...
%global pkg_name fkie_message_filters
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-fkie-message-filters
Version:        3.4.0
Release:        1%{?dist}
...
* Wed Apr 29 2026 Timo Röhling <timo.roehling@fkie.fraunhofer.de> - 3.3.0-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Timo Röhling <timo.roehling@fkie.fraunhofer.de> - 3.3.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Timo Röhling <timo.roehling@fkie.fraunhofer.de> - 3.3.0-1
- Autogenerated by Bloom
